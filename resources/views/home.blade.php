...
<body class="font-sans antialiased">
    ...
    <header class="fixed top-0 left-0 right-0 z-10 flex justify-between items-center p-4 bg-white shadow">
        ...
        <nav
            class="ml-80 flex-1 justify-start items-center space-x-8 md:space-x-6 lg:space-x-8 xl:space-x-16 hidden md:flex transition-all duration-500">
            <a href="/"
                class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500">Beranda</a>
            <a href="#"
                class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500">Layanan</a>
            <a href="#"
                class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500">Pelaporan</a>
            <a href="#"
                class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500">Tracking</a>
            <a href="/faq"
                class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500">FAQ</a>
            @auth
                <div class="relative">
                    <button class="text-gray-800 font-bold text-md lg:text-lg md:text-sm transition-all duration-500"
                        id="user-menu-button">
                        {{ Auth::user()->name }}
                    </button>
            ...
            @else
                <a href="/login"
                    class="bg-blue-500 hover:bg-blue-600 text-white md:px-5 md:py-2 lg:px-10 lg:py-3 rounded-3xl transition-all duration-300 font-bold text-md shadow-2xl">Login</a>
            @endauth
        </nav>
        <script>
    ...
    <section class="relative bg-cover bg-center text-white text-center">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-start text-white p-4 lg:p-20">
            ...
            <p class="mt-6 max-w-2xl text-base lg:text-xl font-normal text-left">Dinas Komunikasi dan Informatika Kota
                Pekalongan adalah Organisasi Perangkat Daerah yang dibentuk untuk menyelenggarakan urusan Pemerintahan
                bidang informasi dan komunikasi publik, bidang infrastruktur dan statistika, bidang aplikasi dan
                persandian.</p>
        </div>
    </section>
    ...
    <section class="my-8 max-w-4xl mx-auto text-center">
        <div class="relative inline-block w-full sm:w-2/3 lg:w-2/3">
            <input type="text" placeholder="Cari Layanan..."
                class="w-full p-2 pl-4 pr-12 border rounded-full bg-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
    ...
    <section class="my-8 max-w-4xl mx-auto text-center">
        <div class="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 items-center">
            <div
                class="card bg-white p-8 rounded-xl shadow-lg max-w-md mx-auto hover:shadow-2xl transition-shadow duration-300">
                ...
                <div class="text-left sm:text-left">
                    ...
                    <p class="mt-2">Ajukan keluhan dan tinjau Prosedur Operasional Standar (SOP) untuk layanan yang
                        tersedia.</p>
                </div>
            </div>
            <div
    ...
    <footer class="bg-gray-100 p-8 text-center sm:text-left">
        <div class="flex flex-col sm:flex-row items-start sm:items-start justify-between max-w-7xl mx-auto">
            <div class="flex flex-col items-start mb-4 sm:mb-0">
                ...
                <p class="text-sm md:text-base mt-4 max-w-sm">Dinas Komunikasi dan Informatika Kota Pekalongan adalah
                    Organisasi Perangkat Daerah yang dibentuk untuk menyelenggarakan urusan Pemerintahan bidang
                    informasi dan komunikasi publik, bidang infrastruktur dan statistika, bidang aplikasi dan
                    persandian.</p>
            </div>
            ...
            <div class="flex flex-col items-start mt-4 sm:mt-20 sm:ml-4">
                ...
                <p class="contact-item" style="display: inline-flex; align-items: center;">
                    <img src="images/phone.png" alt="Phone Icon" class="icon" style="margin-right: 10px;"> (0285)
                    421243
                </p>

                <p class="contact-item" style="display: inline-flex; align-items:center">
                    <img src="images/envelope.png" alt="Email Icon" class="icon" style="margin-right: 10px;">
                    diskominfo@pekalongankota.go.id
                </p>

                <p class="contact-item" style="display: inline-flex; align-items:center">
                    <img src="images/location.png" alt="Address Icon" class="icon" style="margin-right: 10px;">
                    Jl. Majapahit No.5 Pekalongan
                </p>
            </div>
        </div>
